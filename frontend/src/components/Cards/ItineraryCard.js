  ...
  return (
    <Row style={{ padding: 15, width: 350, }}>
      ...
      <Row style={{ margin: 0, padding: 0 }}>
        ...
        <Col>
          <div style={{ fontSize: 12, marginTop: 10, textAlign: 'right', color: 'gray' }}>{location}</div>
          <div style={{ fontSize: 10, marginTop: 10, textAlign: 'right' }}>{formattedStartDate} - {formattedEndDate}</div>
